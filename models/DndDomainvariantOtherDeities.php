...
/**
 * This is the model class for table "dnd_domainvariant_other_deities".
 *
 * @property integer $id
 ...
 */
class DndDomainvariantOtherDeities extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'dnd_domainvariant_other_deities';
    }
